const fs = require('fs-extra') 
 ...
 global.website = 'https://github.com/vajirabot1/KING-VAJIRA' //wa.me/+91000000000000 
...
voice  :  process.env.AUTO_VOICE === undefined ? false : process.env.AUTO_VOICE, 
   ...
   BRANCH: 'main',  
   ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'defalt' : process.env.ALIVE_MESSAGE, 
